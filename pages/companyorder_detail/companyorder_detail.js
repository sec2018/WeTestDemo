...
Page({
   ...
   */
  onReady: function () {
    let data = wx.getStorageSync('companyorderDetail');
  ...
  receiveBill() {
    ...
    utils.wxResquest({
      url: '/transport/api/receivecompanybill',
      data: dataParam,
      method: 'POST'
    }, function (res) {
      if (res.data.success) {
    ...
    wx.showModal({
      ...
      success(res) {
        if (res.confirm) {
          ...
          utils.wxResquest({
            url: '/transport/api/deletecompanybill',
            data: dataParam,
            method: 'POST'
          }, function (res) {
            if (res.data.success) {
  ...
  finishBill() {
    ...
    utils.wxResquest({
      url: '/transport/api/finishcompanybill',
      data: dataParam,
      method: 'POST'
    }, function (res) {
      if (res.data.success) {
